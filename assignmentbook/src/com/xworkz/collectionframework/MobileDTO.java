...
public void setBatteryCapacity(int batteyCapacity) {
	this.batteryCapacity=batteryCapacity;
}
@Override
public String toString() {
	return"Mobile-[id="+id+",name="+name+",price="+price+",ram="+ram+",rom="+rom+",cameraPixel="+cameraPixel+",batteryCapacity="+batteryCapacity+"]";
