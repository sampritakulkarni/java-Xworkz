...
public class ExceptionErrors {
	...
	public void createExceptionalEvent2() {
		AnnotationFormatError annotation=new  AnnotationFormatError("Pinky");
		throw annotation ;
	}
	...
	public void createExceptionalEvent7() throws BackingStoreException {
		BackingStoreException error =new BackingStoreException ("priya");
		throw  error;
	}
	...
	public void createExceptionalEvent9() throws BadLocationException {
		BadLocationException error = new BadLocationException("chaitra", 8);
		throw error;

	}

	public void createExceptionalEvent10() throws BadStringOperationException {
		BadStringOperationException error = new BadStringOperationException("Deepa");
		throw error;
	}
	...
	public void createExceptionalEvent16() throws TransformerException {
		TransformerException error = new TransformerException("Teju");
		throw error;
	}
	...
	public void createExceptionalEvent19() throws ParseException {
		ParseException error = new ParseException("Pooja", 6);
		throw error;
	}
	...
	public void createExceptionalEvent24() {
		DateTimeException error = new DateTimeException("Soniya");
		throw error;
	}
